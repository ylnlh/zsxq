import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as i,f as n}from"./app-rpFDZqdF.js";const d={},r=n(`<h1 id="javascript高级第-02-天笔记" tabindex="-1"><a class="header-anchor" href="#javascript高级第-02-天笔记" aria-hidden="true">#</a> JavaScript高级第 02 天笔记</h1><h2 id="_1-构造函数和原型" tabindex="-1"><a class="header-anchor" href="#_1-构造函数和原型" aria-hidden="true">#</a> 1 .构造函数和原型</h2><h2 id="_1-1-对象的三种创建方式-复习" tabindex="-1"><a class="header-anchor" href="#_1-1-对象的三种创建方式-复习" aria-hidden="true">#</a> 1. 1 对象的三种创建方式--复习</h2><h5 id="_1-字面量方式" tabindex="-1"><a class="header-anchor" href="#_1-字面量方式" aria-hidden="true">#</a> 1. 字面量方式</h5><h5 id="_2-new关键字" tabindex="-1"><a class="header-anchor" href="#_2-new关键字" aria-hidden="true">#</a> 2. new关键字</h5><h5 id="_3-构造函数方式" tabindex="-1"><a class="header-anchor" href="#_3-构造函数方式" aria-hidden="true">#</a> 3. 构造函数方式</h5><h2 id="_1-2-静态成员和实例成员" tabindex="-1"><a class="header-anchor" href="#_1-2-静态成员和实例成员" aria-hidden="true">#</a> 1. 2 静态成员和实例成员</h2><h4 id="_1-2-1-实例成员" tabindex="-1"><a class="header-anchor" href="#_1-2-1-实例成员" aria-hidden="true">#</a> 1. 2. 1 实例成员</h4><h5 id="实例成员就是构造函数内部通过this添加的成员-如下列代码中uname-age-sing-就是实例" tabindex="-1"><a class="header-anchor" href="#实例成员就是构造函数内部通过this添加的成员-如下列代码中uname-age-sing-就是实例" aria-hidden="true">#</a> 实例成员就是构造函数内部通过this添加的成员 如下列代码中uname age sing 就是实例</h5><h5 id="成员-实例成员只能通过实例化的对象来访问" tabindex="-1"><a class="header-anchor" href="#成员-实例成员只能通过实例化的对象来访问" aria-hidden="true">#</a> 成员,实例成员只能通过实例化的对象来访问</h5><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>var obj = {};
