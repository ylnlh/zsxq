...
git branch -M main
git push -u origin main
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="git-page" tabindex="-1"><a class="header-anchor" href="#git-page" aria-hidden="true">#</a> git page</h5><ul><li>Settings <img src="`+u+'" alt="Settings" loading="lazy"></li><li>Pages <img src="'+v+'" alt="Pages" loading="lazy"></li><li></li><li>github Action 推送和部署分支 <img src="'+c+'" alt="Pages" loading="lazy"><img src="'+o+'" alt="Pages" loading="lazy"></li></ul><p>注意：您可以通过私下发布来限制对GitHub Pages网站的访问。私人发布的网站只能由对发布网站的存储库具有读取权限的人访问。您可以使用私人发布的网站与企业成员共享内部文档或知识库。</p>',19),E={id:"主题配置",tabindex:"-1"},w=e("a",{class:"header-anchor",href:"#主题配置","aria-hidden":"true"},"#",-1),V={href:"https://v2.vuepress.vuejs.org/zh/reference/default-theme/config.html#navbar",target:"_blank",rel:"noopener noreferrer"},P=d(`<ul><li>hostname 仅限 Root</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    它应该包含完整协议 (如: https://example.com)。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14);function D(A,M){const n=a("ExternalLinkIcon");return t(),r("div",null,[b,e("h3",g,[h,i(),e("a",p,[i("创建vuepress"),s(n)])]),x,e("h3",q,[_,i(),e("a",f,[i("配置主题"),s(n)])]),k,e("ol",null,[e("li",null,[e("a",y,[i("主题官网"),s(n)])]),j]),z,e("h3",E,[w,i(),e("a",V,[i("主题配置"),s(n)])]),P])}const L=l(m,[["render",D],["__file","ppt.html.vue"]]);export{L as default};
