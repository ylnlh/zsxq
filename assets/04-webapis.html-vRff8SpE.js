import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,f as a}from"./app-hz3rNBT8.js";const d={},s=a(`<p>​</p><h1 id="day04-web-apis" tabindex="-1"><a class="header-anchor" href="#day04-web-apis" aria-hidden="true">#</a> day04 - Web APIs</h1><h5 id="学习目标" tabindex="-1"><a class="header-anchor" href="#学习目标" aria-hidden="true">#</a> 学习目标：</h5><h5 id="能够说出常用的3-5个键盘事件" tabindex="-1"><a class="header-anchor" href="#能够说出常用的3-5个键盘事件" aria-hidden="true">#</a> 能够说出常用的3-5个键盘事件</h5><h5 id="能够知道如何获取当前键盘按下的是哪个键" tabindex="-1"><a class="header-anchor" href="#能够知道如何获取当前键盘按下的是哪个键" aria-hidden="true">#</a> 能够知道如何获取当前键盘按下的是哪个键</h5><h5 id="能够知道浏览器的顶级对象window" tabindex="-1"><a class="header-anchor" href="#能够知道浏览器的顶级对象window" aria-hidden="true">#</a> 能够知道浏览器的顶级对象window</h5><h5 id="能够使用window-onload事件" tabindex="-1"><a class="header-anchor" href="#能够使用window-onload事件" aria-hidden="true">#</a> 能够使用window.onload事件</h5><h5 id="能够使用window-onresize事件" tabindex="-1"><a class="header-anchor" href="#能够使用window-onresize事件" aria-hidden="true">#</a> 能够使用window.onresize事件</h5><h5 id="能够说出两种定时器的区别" tabindex="-1"><a class="header-anchor" href="#能够说出两种定时器的区别" aria-hidden="true">#</a> 能够说出两种定时器的区别</h5><h5 id="能够使用location对象的href属性完成页面之间的跳转" tabindex="-1"><a class="header-anchor" href="#能够使用location对象的href属性完成页面之间的跳转" aria-hidden="true">#</a> 能够使用location对象的href属性完成页面之间的跳转</h5><h5 id="能够使用location对象获取url中的参数部分" tabindex="-1"><a class="header-anchor" href="#能够使用location对象获取url中的参数部分" aria-hidden="true">#</a> 能够使用location对象获取url中的参数部分</h5><h5 id="能够使用history提供的方法实现页面刷新" tabindex="-1"><a class="header-anchor" href="#能够使用history提供的方法实现页面刷新" aria-hidden="true">#</a> 能够使用history提供的方法实现页面刷新</h5><h2 id="_1-1-常用的键盘事件" tabindex="-1"><a class="header-anchor" href="#_1-1-常用的键盘事件" aria-hidden="true">#</a> 1.1. 常用的键盘事件</h2><h2 id="_1-1-1-键盘事件" tabindex="-1"><a class="header-anchor" href="#_1-1-1-键盘事件" aria-hidden="true">#</a> 1.1.1 键盘事件</h2><h3 id="_1-1-2-键盘事件对象" tabindex="-1"><a class="header-anchor" href="#_1-1-2-键盘事件对象" aria-hidden="true">#</a> 1.1.2 键盘事件对象</h3><h5 id="使用keycode属性判断用户按下哪个键" tabindex="-1"><a class="header-anchor" href="#使用keycode属性判断用户按下哪个键" aria-hidden="true">#</a> 使用keyCode属性判断用户按下哪个键</h5><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;script&gt;
// 常用的键盘事件
//1. keyup 按键弹起的时候触发
