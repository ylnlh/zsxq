...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,16),q={id:"配置主题",tabindex:"-1"},_=e("a",{class:"header-anchor",href:"#配置主题","aria-hidden":"true"},"#",-1),f={href:"https://www.npmjs.com/package/vuepress-theme-hope",target:"_blank",rel:"noopener noreferrer"},k=e("p",null,"自己选一个主题",-1),y={href:"https://theme-hope.vuejs.press/zh/get-started/create.html",target:"_blank",rel:"noopener noreferrer"},j=e("li",null,"在终端中执行下列命令之一:",-1),E=d(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>pnpm create vuepress-theme-hope my-docs
